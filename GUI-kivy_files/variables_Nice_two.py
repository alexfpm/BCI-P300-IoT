...
def erps_calculation(arduinoData, opSesameData, datesArduino):
    ...
    labels2 = np.zeros(len(ch2_Nice))
    
    ch2_Nice = ch2_Nice*1000
    
    
    #CH2
    samplerate = 250.
    timeLine = np.arange(ch2_Nice.shape[0]) / samplerate
    ...
    for w in range(len(flagInd)):
        ...
        for x in range(flagInd2[w]):
            ...
            trialsFlags[w].append(ch2_Nice[aux1[x] : aux1[x]+snippet])
    #-----------------------------------------------------------------    
    ...
    return erps, flagInd, samplerate, negative_shape, ch2_Nice
    #-----------------------------------------------------------------
