 ...
 * 
  ...
  then asks for a prompt to take 'numSampGG' samples at the rate of 250sps.
...
//Every 5000 samples are 20 secs of sampling (250 SPS)
int numSampGG = 15000;
...
void setup() {
  ...
  //Modify registers of the Channels
...
void loop(){
  ...
  if (testing){
    ...
    //Printint datafor benchmark
    Serial.print("\nElapsed Time ");Serial.println(elapsedTime);
